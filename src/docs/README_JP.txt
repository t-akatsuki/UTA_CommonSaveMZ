...
# 概要
#------------------------------------------------------------------------------
セーブデータ間で共有のセーブデータを作成し、指定したスイッチ・変数の状態を
セーブデータ間で共有するRPGツクールMZ用プラグインです。
...
# 利用方法
#------------------------------------------------------------------------------
ご自身のプロジェクトに「UTA_CommonSaveMZ.js」を配置し、プラグインの有効化、
...
#------------------------------------------------------------------------------
・0.9.1 (2020/11/11)
プラグインパラメータ「共有対象スイッチ番号」もしくは「共有対象変数番号」を指定していないと
正常動作しない不具合の修正。
